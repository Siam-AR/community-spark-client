        ...
        {comments.length === 0 ? (
          <Card className="border border-slate-200 p-8 text-center shadow-sm">
            ...
            <div className="mt-6 flex justify-center gap-3">
              <Button variant="primary" onPress={() => router.push("/projects")}>Browse Community Projects</Button>
              <Button variant="outline" onPress={() => router.push("/my-projects")}>My Projects</Button>
            </div>
          </Card>
        ) : (
              ...
              >
                ...
                <div className="flex flex-1 flex-col p-5">
                  ...
                  <div className="mt-auto flex gap-3 pt-5">
                    ...
                    <Link href={comment.idea?._id ? `/projects/${comment.idea._id}` : "/projects"} className="flex-1">
